...
" mappings {{{1
" insert a chechbox
noremap <silent> <localleader>cb :call SafelyInsertCheckBox()<cr>
noremap <silent> <localleader>c% :call SafelyInsertCheckBoxPercent()<cr>
noremap <silent> <localleader>cp :call SafelyInsertCheckBoxPercentAlways()<cr>
noremap <silent> <localleader>cB :call InsertCheckBox()<cr>

" delete a chechbox
noremap <silent> <localleader>cd :call DeleteCheckbox()<cr>
...
if !exists('g:vo_checkbox_fast_calc') || g:vo_checkbox_fast_calc == 1
	...
	noremap <silent> <localleader>cx :call SwitchBox()       <bar>call CalculateMyBranch(line("."))<cr>
	noremap <silent> <localleader>c+ :call IncPercent(".")   <bar>call CalculateMyBranch(line("."))<cr>
	noremap <silent> <localleader>c- :call DecPercent(".")   <bar>call CalculateMyBranch(line("."))<cr>
	noremap <silent> <localleader>c1 :call SetPercent(".",10)<bar>call CalculateMyBranch(line('.'))<cr>
	noremap <silent> <localleader>c2 :call SetPercent(".",20)<bar>call CalculateMyBranch(line('.'))<cr>
	noremap <silent> <localleader>c3 :call SetPercent(".",30)<bar>call CalculateMyBranch(line('.'))<cr>
	noremap <silent> <localleader>c4 :call SetPercent(".",40)<bar>call CalculateMyBranch(line('.'))<cr>
	noremap <silent> <localleader>c5 :call SetPercent(".",50)<bar>call CalculateMyBranch(line('.'))<cr>
	noremap <silent> <localleader>c6 :call SetPercent(".",60)<bar>call CalculateMyBranch(line('.'))<cr>
	noremap <silent> <localleader>c7 :call SetPercent(".",70)<bar>call CalculateMyBranch(line('.'))<cr>
	noremap <silent> <localleader>c8 :call SetPercent(".",80)<bar>call CalculateMyBranch(line('.'))<cr>
	noremap <silent> <localleader>c9 :call SetPercent(".",90)<bar>call CalculateMyBranch(line('.'))<cr>
else
	" Use the old method
	noremap <silent> <localleader>cx :call SwitchBox()       <bar>call NewHMD(FindRootParent(line(".")))<cr>
	noremap <silent> <localleader>c+ :call IncPercent(".")   <bar>call NewHMD(FindRootParent(line(".")))<cr>
	noremap <silent> <localleader>c- :call DecPercent(".")   <bar>call NewHMD(FindRootParent(line(".")))<cr>
	noremap <silent> <localleader>c1 :call SetPercent(".",10)<bar>call NewHMD(FindRootParent(line(".")))<cr>
	noremap <silent> <localleader>c2 :call SetPercent(".",20)<bar>call NewHMD(FindRootParent(line(".")))<cr>
	noremap <silent> <localleader>c3 :call SetPercent(".",30)<bar>call NewHMD(FindRootParent(line(".")))<cr>
	noremap <silent> <localleader>c4 :call SetPercent(".",40)<bar>call NewHMD(FindRootParent(line(".")))<cr>
	noremap <silent> <localleader>c5 :call SetPercent(".",50)<bar>call NewHMD(FindRootParent(line(".")))<cr>
	noremap <silent> <localleader>c6 :call SetPercent(".",60)<bar>call NewHMD(FindRootParent(line(".")))<cr>
	noremap <silent> <localleader>c7 :call SetPercent(".",70)<bar>call NewHMD(FindRootParent(line(".")))<cr>
	noremap <silent> <localleader>c8 :call SetPercent(".",80)<bar>call NewHMD(FindRootParent(line(".")))<cr>
	noremap <silent> <localleader>c9 :call SetPercent(".",90)<bar>call NewHMD(FindRootParent(line(".")))<cr>
endif

" calculate the proportion of work done on the subtree
noremap <silent> <localleader>cz :call NewHMD(FindRootParent(line(".")))<cr>

" tag list key mappings
if exists("g:cbTags")
	noremap <silent> <localleader>ct :call SetNextTag()<cr>
	noremap <silent> <localleader>cT :call SetNextList()<cr>
endif
